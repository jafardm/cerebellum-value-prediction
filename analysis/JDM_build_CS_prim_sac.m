function JDM_build_CS_prim_sac(data_path)
JDM_params_funcs
...
function [cs_on_data,perturb,cs_rate,cs_vm] = par_loop_cs_on_data...
    ...
    cs_rate = nan(num_cs,500,8,2,2);
    cs_vm  = nan(num_cs,500,8,2,2);
...
res.rate_tot = cat(4, cs_rate_tot_vis, cs_rate_tot_sac); % [500 x 8 x 3 x 2]
