function plot_end_point_error_contour_prim_sac(data_path)
...
for jj = 1:num_subjects
    ...
    % High = [1;2], Low = [3;4]
    data_groups = {
        [data_error{1}; data_error{2}], ...
        [data_error{3}; data_error{4}]
    };
    ...
    % Save figure
    fname = sprintf('%s-high-vs-low-endpoint-density.pdf', subj_names{jj});
